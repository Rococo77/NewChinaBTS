 ...
 */
final class Version20240420123747 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE panier (id INT AUTO_INCREMENT NOT NULL, users_id INT DEFAULT NULL, quantité INT NOT NULL, INDEX IDX_24CC0DF267B3B43D (users_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE plat (id INT AUTO_INCREMENT NOT NULL, panier_id INT DEFAULT NULL, region_id INT NOT NULL, nom VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, prix_unit DOUBLE PRECISION NOT NULL, stock_qtt INT DEFAULT NULL, peremption_date DATE DEFAULT NULL, allergen VARCHAR(255) DEFAULT NULL, INDEX IDX_2038A207F77D927C (panier_id), INDEX IDX_2038A20798260155 (region_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
